            ...
            <div class="container">
                <div class="homepage owl-carousel">
                    <div class="item">
                        <div class="row">
                            <div class="col-sm-6">
                                <img class="img-responsive" src="img/banner-1.png" alt="">
                            </div>
                            <div class="col-sm-6">
                                <h1>Hot Promo Mei</h1>
                                <p>
                                    Segera daftarkan diri anda di sini dan dapatkan keuntungannya.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-center">
                                <img class="img-responsive" src="img/banner-2.png" alt="">
                            </div>
        ...
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <p class="lead">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis
                    ...
                    libero sit amet quam egestas semper. Aenean ultricies
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="lead">We have prepared for you more than 40 different HTML pages, including 5 variations
                        of homepage.</p>
                    <p class="text-center">
